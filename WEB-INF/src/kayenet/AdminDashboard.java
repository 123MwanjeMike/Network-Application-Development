...
class AES { //AES encryption algorithm
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    if(session!=null){
      ...
      out.println("<!DOCTYPE html>\n" +
        ...
        "				<h2 class=\"dummy-heading\">Administrator</h2>\n" +
        "			</div>\n" +
        "			<div class=\"bp-header__main\">\n" +
        "				<span class=\"bp-header__present\"><span class=\"bp-tooltip bp-icon bp-icon--about\" data-content=\"\"></span></span>\n" +
        "				\n" +
        "			</div>\n" +
        "		</header>\n" +
        "\n" +
      ...
      try {
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/kayenet","root","the3demos.");
    ...
    try {
      ...
      for(int l = 0 ; l < j ; l ++ ){
        ...
        out.println("<tr class=\"row100 body\"><td class=\"cell100 column1\">Date: " +
         dates[l]+"</td><td class=\"cell100 column1\">Total: UGX "+
         values_got[l]+"</td></tr>");
      }
    }catch(ClassNotFoundException | SQLException e){
      out.println(e);
    ...
    try {
      ...
      for(int l = 0 ; l < j ; l ++ ){
        //calculates the total for  each date
        //out.println("Total sales for "+ dates[l]+ " "+values_got[l]+"<br>");
        out.println("<tr class=\"row100 body\"><td class=\"cell100 column1\">Date: " + dates[l]+
          "</td><td class=\"cell100 column1\">Total: UGX "+values_got[l]+
          "</td></tr>");
      }
    }catch(ClassNotFoundException | SQLException e){
      out.println(e);
